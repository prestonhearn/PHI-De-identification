import os
from Recognizer import AddressRecognizer, DOBRecognizer, TitleRecognizer, PostNominalRecognizer, SSNRecognizer
...
for file_path in file_path:
    ...
    results = analyzer.analyze(text=content,
                            entities=["PERSON", "ADDRESS", "DOB", "SSN", "PHONE_NUMBER", "EMAIL_ADDRESS", "TITLE", "POSTNOMINAL"],
                            language='en')
